...
# a temperature in Fahrenheit, and converts it to c_temp, that
...
# 3.
# Write a function called c_to_f that takes an input c_temp, a temperature in Celsius, and converts it to f_temp,
...
#  Make sure to uncomment those lines before trying to use these variables.
...
# bomb_mass has been defined for you at the top of script.py.
# Make sure to uncomment this line before trying to use bomb_mass.
